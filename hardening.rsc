...
To ensure your script continues even if an error occurs at the firewall configuration step, you can use the :do { ... } on-error={ ... } construct around the firewall commands. This way, the script will handle errors gracefully and proceed with subsequent commands.
...
:do {
    ...
    :put "[-] Error occurred while building firewall, skipping"
}
